      ...
      <ul style="list-style: none; padding: 0;">
        {% for post in site.posts %}
          ...
          <li style="margin-bottom: 20px; border-bottom: 1px dashed #eee; padding-bottom: 15px;">
            <a href="{{ post.url | relative_url }}" style="font-weight: bold; text-decoration: none; color: #ff5722; font-size: 1.1em; display: block;">{{ post.title }}</a>
    ...
    <section class="cat-section" style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
      ...
      <ul style="list-style: none; padding: 0;">
        {% for post in site.posts %}
          ...
          <li style="margin-bottom: 20px; border-bottom: 1px dashed #eee; padding-bottom: 15px;">
            <a href="{{ post.url | relative_url }}" style="font-weight: bold; text-decoration: none; color: #4CAF50; font-size: 1.1em; display: block;">{{ post.title }}</a>
            <div style="font-size: 0.9em; color: #666;">{{ post.summary }}</div>
          </li>
          {% endif %}
        {% endfor %}
    ...
    <section class="cat-section" style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
      ...
      <ul style="list-style: none; padding: 0;">
        {% for post in site.posts %}
          ...
          <li style="margin-bottom: 20px; border-bottom: 1px dashed #eee; padding-bottom: 15px;">
            <a href="{{ post.url | relative_url }}" style="font-weight: bold; text-decoration: none; color: #2196F3; font-size: 1.1em; display: block;">{{ post.title }}</a>
            <div style="font-size: 0.9em; color: #666;">{{ post.summary }}</div>
          </li>
          {% endif %}
        {% endfor %}
